...
import { Clipboard, Download, ExternalLink, FileJson, RotateCcw } from "lucide-react";
import { useTranslation } from "react-i18next";
import i18n from "../i18n";
import { ShareButtons } from "../ShareButtons";
import { formatNumber, formatPercent, normalizedProvider, textReport, tickerRows, visibleLanguageColor } from "../reportUtils";
...
export function ReportUtilityActions({
  report,
  copiedCta,
  onCopyBadge,
  onCopyEmbed,
